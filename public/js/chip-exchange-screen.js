function buildChangeChipsHtml() {
    ...
    html += `            </div>`;
    html += `            <div class="grid-item">`;
    html += `                <img src="images/chip-green.png" class="imgreduced"></img>`;
    html += `                <br>`;
    ...
    html += `            </div>`;
    html += `            <div class="grid-item">`;
    html += `                <img src="images/chip-red.png" class="imgreduced"></img>`;
    html += `                <br>`;
    ...
    html += `            </div>`;
    html += `            <div class="grid-item">`;
    html += `                <img src="images/chip-gray.png" class="imgreduced"></img>`;
    html += `                <br>`;
